...
def run_smo_visualization():
    ...
    best_path, evolution = smo_basic_loop(pop_size=pop_size,max_iter=max_iter,wait_iterations=wait_iterations,max_r=max_r,path_size=path_size,scenario=scenario,n_neighbours=5)
